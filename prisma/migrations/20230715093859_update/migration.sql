...
CREATE TABLE "CommentVote" (
    ...
    CONSTRAINT "CommentVote_pkey" PRIMARY KEY ("userId","commendId")
);
...
-- AddForeignKey
ALTER TABLE "CommentVote" ADD CONSTRAINT "CommentVote_commendId_fkey" FOREIGN KEY ("commendId") REFERENCES "Comment"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
